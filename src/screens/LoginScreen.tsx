...
const LoginScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    setErrors({});
    const res = await dispatch(login({ phone: userName, password, isRemember }));
      ...
      <View style={{ height: '40%' }}>
        <ImageBackground source={BackgroundImage} style={styles.headerBg} resizeMode="stretch">
          <View style={styles.headerIcons}>
            ...
            />
            <Icon name="search" size={28} color="#000" style={styles.iconBg} />
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity style={styles.savedAccountsLink} onPress={showSavedAccounts}>
                ...
                <Icon name="save-outline" size={22} color="#EE4E89" />
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  forgotText: { ...globalStyle.font, color: '#EE4E89', textDecorationLine: 'underline' },
  signupText: { ...globalStyle.font, marginTop: 15, color: '#666' },
